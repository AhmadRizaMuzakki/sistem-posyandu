...
trait IbuHamilCrud
{
    ...
    private function resetIbuHamilFields()
    {
        ...
        $this->tanggal_lahir_ibuhamil = $today['ymd'];
        $this->hari_lahir_ibuhamil = $today['hari'];
        $this->bulan_lahir_ibuhamil = $today['bulan'];
        $this->tahun_lahir_ibuhamil = $today['tahun'];
        $this->jenis_kelamin_ibuhamil = '';
        $this->status_keluarga_ibuhamil = '';
        $this->umur_sasaran_ibuhamil = 0;
