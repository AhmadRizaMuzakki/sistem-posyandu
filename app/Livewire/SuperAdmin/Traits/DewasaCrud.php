...
trait DewasaCrud
{
    ...
    private function resetDewasaFields()
    {
        ...
        $this->tanggal_lahir_dewasa = $today['ymd'];
        $this->hari_lahir_dewasa = $today['hari'];
        $this->bulan_lahir_dewasa = $today['bulan'];
        $this->tahun_lahir_dewasa = $today['tahun'];
        $this->jenis_kelamin_dewasa = '';
        $this->status_keluarga_dewasa = '';
        $this->umur_sasaran_dewasa = 0;
