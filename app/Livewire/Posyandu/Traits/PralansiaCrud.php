...
trait PralansiaCrud
{
    ...
    private function resetPralansiaFields()
    {
        ...
        $this->tanggal_lahir_pralansia = $today['ymd'];
        $this->hari_lahir_pralansia = $today['hari'];
        $this->bulan_lahir_pralansia = $today['bulan'];
        $this->tahun_lahir_pralansia = $today['tahun'];
        $this->jenis_kelamin_pralansia = '';
        $this->status_keluarga_pralansia = '';
        $this->umur_sasaran_pralansia = 0;
