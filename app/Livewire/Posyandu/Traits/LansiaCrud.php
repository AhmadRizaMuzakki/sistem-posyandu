...
trait LansiaCrud
{
    ...
    private function resetLansiaFields()
    {
        ...
        $this->tanggal_lahir_lansia = $today['ymd'];
        $this->hari_lahir_lansia = $today['hari'];
        $this->bulan_lahir_lansia = $today['bulan'];
        $this->tahun_lahir_lansia = $today['tahun'];
        $this->jenis_kelamin_lansia = '';
        $this->status_keluarga_lansia = '';
        $this->umur_sasaran_lansia = 0;
    ...
    public function storeLansia()
    {
        ...
        DB::transaction(function () use ($umur, $nik_orangtua, $posyanduId, &$userId, &$lansia) {
