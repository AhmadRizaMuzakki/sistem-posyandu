        ...
        foreach ($imunisasiList as $item) {
            ...
            foreach ($item['imunisasi'] as $im) {
                ...
                $rows->push((object) [
                    ...
                    'lingkar_kepala' => $im->lingkar_kepala !== null ? number_format($im->lingkar_kepala, 1, ',', '.') : '-',
    ...
    private function buildImunisasiAnalytics(Collection $imunisasiList, AntropometriService $antropometri): array
    {
        ...
        foreach ($imunisasiList as $item) {
            ...
            if (count($labels) > 0) {
                ...
                $grafikPertumbuhan[] = [
                    'nama' => $sasaran['nama'] ?? '-',
                    'kategori' => $this->kategoriLabel($slug),
                    'kategori_slug' => $slug,
                    'labels' => $labels,
                    'berat' => $berat,
                    'tinggi' => $tinggi,
            ...
            $penilaianList[] = [
                ...
                'lingkar_kepala' => $terakhir?->lingkar_kepala,
