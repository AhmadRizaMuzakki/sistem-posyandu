                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            @php
                                if (isset($posyandu) && !$id_posyandu_pendidikan) {
                                    $this->id_posyandu_pendidikan = $posyandu->id_posyandu;
                            ...
                            @error('id_posyandu_pendidikan') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                        </div>
                        ...
                        <div>
                            ...
                            @if(empty($sasaranList) && $id_posyandu_pendidikan)
                                <p class="text-xs text-gray-500 mt-1">Belum ada sasaran di posyandu ini. Tambahkan sasaran terlebih dahulu.</p>
                            @endif
                        </div>
