                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <x-tanggal-dmy-input
                            label="Tanggal Lahir"
                            :required="true"
                            hari="hari_lahir_pralansia"
                            bulan="bulan_lahir_pralansia"
                            tahun="tahun_lahir_pralansia"
                            error-hari="hari_lahir_pralansia"
                            error-bulan="bulan_lahir_pralansia"
                            error-tahun="tahun_lahir_pralansia"
                            error-tanggal="tanggal_lahir_pralansia"
                        />
                        <div>
