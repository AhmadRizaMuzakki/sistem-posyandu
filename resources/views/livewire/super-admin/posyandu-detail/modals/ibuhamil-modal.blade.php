                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <x-tanggal-dmy-input
                            label="Tanggal Lahir"
                            :required="true"
                            hari="hari_lahir_ibuhamil"
                            bulan="bulan_lahir_ibuhamil"
                            tahun="tahun_lahir_ibuhamil"
                            error-hari="hari_lahir_ibuhamil"
                            error-bulan="bulan_lahir_ibuhamil"
                            error-tahun="tahun_lahir_ibuhamil"
                            error-tanggal="tanggal_lahir_ibuhamil"
                        />
                        <div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <x-tanggal-dmy-input
                                ...
                                :required="false"
                                hari="hari_lahir_suami_ibuhamil"
                                bulan="bulan_lahir_suami_ibuhamil"
                                tahun="tahun_lahir_suami_ibuhamil"
                                error-hari="hari_lahir_suami_ibuhamil"
                                error-bulan="bulan_lahir_suami_ibuhamil"
                                error-tahun="tahun_lahir_suami_ibuhamil"
                                error-tanggal="tanggal_lahir_suami_ibuhamil"
                            />
                            <div>
