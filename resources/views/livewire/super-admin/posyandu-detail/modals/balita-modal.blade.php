                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" inputmode="numeric" maxlength="16" pattern="[0-9]*" wire:model="nik_sasaran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="NIK Sasaran">
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{
                                open: false,
                                searchText: '',
                                selectedNoKk: @entangle('no_kk_sasaran'),
                                noKkList: @js($this->getNoKkList())
                            }" x-init="
                                $watch('selectedNoKk', value => {
                                    if (value) {
                                        ...
                                        if (item) {
                                            ...
                                            setTimeout(() => {
                                                $wire.call('loadOrangtuaByNoKk', value);
                                            }, 150);
                                        } else {
                                            searchText = value;
                                        }
                            ...
                            ">
                                <input
                                    ...
                                    @input="
                                        ...
                                        if (match && !noKkList.find(item => item.no_kk == match[0])) {
                                            ...
                                            $wire.set('no_kk_sasaran', match[0]);
                                        }
                                    "
                                ...
                                <div x-show="open"
                                     ...
                                     style="display: none;">
                                    <ul class="py-1">
                                        <li @click="selectedNoKk = ''; searchText = ''; open = false; $wire.set('no_kk_sasaran', '')"
                                            class="px-4 py-2 text-sm text-gray-500 hover:bg-gray-100 cursor-pointer">
                                            -- Pilih No. KK --
                                        </li>
                                        @if(count($this->getNoKkList()) > 0)
                                            @foreach($this->getNoKkList() as $item)
                                                <li @click="
                                                    const noKk = '{{ $item['no_kk'] }}';
                                                    selectedNoKk = noKk;
                                                    searchText = '{{ $item['no_kk'] }} ({{ $item['nama_orangtua'] }}) - {{ $item['jumlah_anggota'] }} anggota';
                                                    open = false;
                                                    $wire.set('no_kk_sasaran', noKk);
                                                    // Panggil method untuk auto-fill data orangtua
                                                    setTimeout(() => {
                                                        $wire.call('loadOrangtuaByNoKk', noKk);
                                                    }, 200);
                                                "
                        ...
                        <x-tanggal-dmy-input
                            label="Tanggal Lahir"
                            :required="true"
                            hari="hari_lahir_sasaran"
                            bulan="bulan_lahir_sasaran"
                            tahun="tahun_lahir_sasaran"
                            error-hari="hari_lahir_sasaran"
                            error-bulan="bulan_lahir_sasaran"
                            error-tahun="tahun_lahir_sasaran"
                            error-tanggal="tanggal_lahir_sasaran"
                        />
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" inputmode="numeric" maxlength="16" pattern="[0-9]*" wire:model="nik_orangtua" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="NIK salah satu orangtua">
                        ...
                        <x-tanggal-dmy-input
                            ...
                            :required="true"
                            hari="hari_lahir_orangtua"
                            bulan="bulan_lahir_orangtua"
                            tahun="tahun_lahir_orangtua"
                            error-hari="hari_lahir_orangtua"
                            error-bulan="bulan_lahir_orangtua"
                            error-tahun="tahun_lahir_orangtua"
                            error-tanggal="tanggal_lahir_orangtua"
                        />
                        <div>
                        ...
                        <div>
                            ...
                            <select wire:model="status_keluarga_orangtua" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary">
                                <option value="">Pilih Status Keluarga...</option>
                                <option value="kepala keluarga">Kepala Keluarga</option>
                                <option value="istri">Istri</option>
