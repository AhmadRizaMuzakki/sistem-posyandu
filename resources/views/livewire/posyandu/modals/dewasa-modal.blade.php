                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" inputmode="numeric" maxlength="16" pattern="[0-9]*" wire:model="nik_sasaran_dewasa" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="NIK Sasaran">
                        ...
                        <div>
                            ...
                            <input type="text" inputmode="numeric" maxlength="16" pattern="[0-9]*" wire:model="no_kk_sasaran_dewasa" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="No. KK (opsional)">
                        ...
                        <x-tanggal-dmy-input
                            label="Tanggal Lahir"
                            :required="true"
                            hari="hari_lahir_dewasa"
                            bulan="bulan_lahir_dewasa"
                            tahun="tahun_lahir_dewasa"
                            error-hari="hari_lahir_dewasa"
                            error-bulan="bulan_lahir_dewasa"
                            error-tahun="tahun_lahir_dewasa"
                            error-tanggal="tanggal_lahir_dewasa"
                        />
                        <div>
                        ...
                        <div>
                            ...
                            <select wire:model="status_keluarga_dewasa" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary">
                                <option value="">Pilih Status Keluarga...</option>
                                <option value="kepala keluarga">Kepala Keluarga</option>
                                <option value="istri">Istri</option>
                                <option value="anak">Anak</option>
                            </select>
                            @error('status_keluarga_dewasa') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select wire:model="pendidikan_dewasa" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary">
                                <x-pendidikan-options />
                            </select>
                            @error('pendidikan_dewasa') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                        </div>
                        <div class="md:col-span-2">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="rt_dewasa" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="RT">
                            @error('rt_dewasa') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-bold mb-2">RW</label>
                            <input type="text" wire:model="rw_dewasa" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-primary focus:border-primary" placeholder="RW">
                            @error('rw_dewasa') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                        </div>
                        <div>
