                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2 sm:max-w-[calc(50%-0.5rem)]">
                                <label class="block text-gray-700 text-sm font-bold mb-2">
                                    Lingkar Kepala
                                    <span class="font-normal text-gray-500 text-xs">(khusus Bayi/Balita)</span>
                                </label>
                                <div class="flex">
                                    <input type="number"
                                           step="0.1"
                                ...
                                @error('lingkar_kepala') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                            </div>
                        </div>
