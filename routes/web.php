...
Route::prefix('supervisor')->middleware(['auth', 'verified', 'role:superadmin'])->group(function () {
    ...
    Route::get('/posyandu/{id}/laporan/absensi-kunjungan/pdf', [LaporanController::class, 'superadminPosyanduAbsensiKunjunganPdf'])->name('superadmin.posyandu.laporan.absensi.kunjungan.pdf');
...
Route::prefix('posyandu')->middleware(['auth', 'verified', 'role:adminPosyandu|superadmin'])->group(function () {
    ...
    Route::get('/laporan/absensi-kunjungan/pdf', [LaporanController::class, 'posyanduAbsensiKunjunganPdf'])->name('adminPosyandu.laporan.absensi.kunjungan.pdf');
